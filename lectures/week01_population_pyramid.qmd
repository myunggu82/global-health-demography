...
You can download the lecture slide here: [Week1_Lecture_Slide](https://github.com/myunggu82/global-health-demography/blob/main/slides/week1_demographic_change.pdf)\
...
head(total_pop_by_year_projection)
head(projection_data)
```
...
1.  **현재 인구구조** (2020): 아동-청년 인구는 적고 중·고령층 비중이 높은 고령사회 구조를 보이고 있음.
2.  **출산 변화**: 1950-70년대에는 삼각형 인구 구조였지만, 1980년대 부터 아동 연령층이 좁아지는 빠른 출산 감소를 보임.
3.  **생존력 변화**: 과거보다 기대수명이 증가하면서 고령까지 생존하는 인구가 크게 확대됨.
4.  **고령화**: 출산 감소와 기대수명 증가가 동시에 진행되면서 빠른 속도로 고령화가 진행 중임.
5.  **미래 인구구조와 건강**: 인구 감소와 초고령화가 심화되며, 노인의 건강과 돌봄 문제가 중요해질 것임.

### 8. 실습

1.  Europe and Northern America / 2. Sub-Saharan Africa / 3. Eastern and South-Eastern Asia
2.  2020년도의 인구피라미드 / 1950-20의 인구피라미드 변화 / 2025-2100 인구피라미드 변화
3.  현재 인구구조 / 출산변화 / 생존력 / 고령화 / 미래인구구조 에 대한 한줄 요약
