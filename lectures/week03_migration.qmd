...
You can download the lecture slide here (Migration): [Week3_Migration](https://github.com/myunggu82/global-health-demography/blob/main/slides/week%203_migration.pdf), [Week3_Mobility](https://github.com/myunggu82/global-health-demography/blob/main/slides/week%203_mobility.pdf)
...
2. Understand the relationships between migration, health, and fertility. \
3. Interpret and visualize migration patterns using demographic data.
